        ...
        for update in updates:
            ...
            if message[0] == "/":
                ...
                if cmd == "/help":
                    ...
                    HELPSTRING += "Si escribes el símbolo / podrás ver los comandos de todos los bots, incluyéndome a mi.\n\n"
                    HELPSTRING += "Si quieres ver mi código fuente, ve a https://github.com/Kyngo/PickleRick."
                    bot.sendMessage(chat_id=chat_id,
                                    text=HELPSTRING,
                                    reply_to_message_id=replyto)
                if cmd == "/update":
